...
def create_resources(models_module=settings.MODELS_MODULE, api_module=settings.RESOURCES_MODULE_NAME):
    data          = collections.namedtuple('data'        , ['models_module', 'api_module', 'resources_map'])
    ...
    result = data(models_module=models_module.__name__, api_module=api_module, resources_map=[])
