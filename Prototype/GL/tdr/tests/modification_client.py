...
class ModificationClient(unittest.TestCase):
    def setUp(self):
    ...
    def test_modification_client(self):
        ...
        driver.find_element_by_name("_save").click()
        # ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
        driver.find_element_by_link_text("client 1").click()
        driver.find_element_by_id("id_num_compte").clear()
        driver.find_element_by_id("id_num_compte").send_keys("2")
        driver.find_element_by_name("_save").click()
        driver.find_element_by_link_text("client 1").click()
        try: self.assertEqual("2", driver.find_element_by_id("id_num_compte").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("id_desscription").clear()
        driver.find_element_by_id("id_desscription").send_keys("test 2")
        driver.find_element_by_name("_save").click()
        driver.find_element_by_link_text("client 1").click()
        try: self.assertEqual("test 2", driver.find_element_by_id("id_desscription").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("id_address").clear()
        driver.find_element_by_id("id_address").send_keys("test 2")
        driver.find_element_by_name("_save").click()
        driver.find_element_by_link_text("client 1").click()
        try: self.assertEqual("test 2", driver.find_element_by_id("id_address").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_name("_save").click()
