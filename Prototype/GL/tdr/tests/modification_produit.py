...
class ModificationProduit(unittest.TestCase):
    def setUp(self):
    ...
    def test_modification_produit(self):
        ...
        driver.find_element_by_link_text("Test Produit").click()
        try: self.assertEqual("Test Produit", driver.find_element_by_id("id_titre").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("id_titre").clear()
        driver.find_element_by_id("id_titre").send_keys("Test Produit 1")
        driver.find_element_by_name("_save").click()
        # ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
        driver.find_element_by_link_text("Test Produit 1").click()
        try: self.assertEqual("Test Produit 1", driver.find_element_by_id("id_titre").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("test 1")
        driver.find_element_by_name("_save").click()
        driver.find_element_by_link_text("Test Produit 1").click()
        try: self.assertEqual("test 1", driver.find_element_by_id("id_description").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_name("_save").click()
