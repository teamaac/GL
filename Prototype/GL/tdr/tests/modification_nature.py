...
class ModificationNature(unittest.TestCase):
	def setUp(self):
	...
	def test_modification_nature(self):
		driver = self.driver
		...
		driver.find_element_by_link_text("Test nature").click()
		driver.find_element_by_id("id_label").clear()
		driver.find_element_by_id("id_label").send_keys("Test nature 1")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		driver.find_element_by_link_text("Test nature 1").click()
		driver.find_element_by_id("id_description").clear()
		driver.find_element_by_id("id_description").send_keys("test 2")
		try: self.assertEqual("Test nature 1", driver.find_element_by_id("id_label").get_attribute("value"))
