...
class CreationComposant(unittest.TestCase):
	def setUp(self):
	...
	def test_creation_composant(self):
		driver = self.driver
		...
		Select(driver.find_element_by_id("id_type_composant")).select_by_visible_text("Shareware")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		driver.find_element_by_link_text("Add composant").click()
		driver.find_element_by_id("id_titre").clear()
		driver.find_element_by_id("id_titre").send_keys("Test composant 3")
		...
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		driver.find_element_by_name("_save").click()
		driver.find_element_by_link_text("Test composant 3").click()
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
