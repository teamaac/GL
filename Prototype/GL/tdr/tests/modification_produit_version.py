...
class ModificationProduitVersion(unittest.TestCase):
	def setUp(self):
	...
	def test_modification_produit_version(self):
		driver = self.driver
		...
		driver.find_element_by_id("id_titre").send_keys("test")
		...
		driver.find_element_by_id("id_designation").send_keys("test")
		driver.find_element_by_id("id_num_compte").clear()
		driver.find_element_by_id("id_num_compte").send_keys("test")
		driver.find_element_by_id("id_desscription").clear()
		driver.find_element_by_id("id_desscription").send_keys("ezrazer")
		driver.find_element_by_id("id_address").clear()
		driver.find_element_by_id("id_address").send_keys("azeraezr")
		driver.find_element_by_name("_save").click()
		driver.find_element_by_id("id_num_compte").clear()
		driver.find_element_by_id("id_num_compte").send_keys("100")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		Select(driver.find_element_by_id("id_etat")).select_by_visible_text("Maintenace")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
		driver.find_element_by_link_text("test : 1.0").click()
		driver.find_element_by_css_selector("img[alt=\"Add Another\"]").click()
		# ERROR: Caught exception [ERROR: Unsupported command [waitForPopUp]]
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		driver.find_element_by_id("id_titre").clear()
		driver.find_element_by_id("id_titre").send_keys("test 2")
		driver.find_element_by_id("id_description").clear()
		driver.find_element_by_id("id_description").send_keys("test")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
