...
class SuppressionProduitVersion(unittest.TestCase):
	def setUp(self):
	...
	def test_suppression_produit_version(self):
		driver = self.driver
		...
		driver.find_element_by_id("id_desscription").send_keys("aezrazer")
		driver.find_element_by_id("id_address").clear()
		driver.find_element_by_id("id_address").send_keys("azeraezr")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		Select(driver.find_element_by_id("id_etat")).select_by_visible_text("Conception")
		driver.find_element_by_name("_addanother").click()
		Select(driver.find_element_by_id("id_produit")).select_by_visible_text("test produit")
		driver.find_element_by_css_selector("#add_id_version > img[alt=\"Add Another\"]").click()
		# ERROR: Caught exception [ERROR: Unsupported command [waitForPopUp]]
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		driver.find_element_by_id("id_label").clear()
		driver.find_element_by_id("id_label").send_keys("1.1")
		driver.find_element_by_id("id_description").clear()
		driver.find_element_by_id("id_description").send_keys("test")
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		Select(driver.find_element_by_id("id_client")).select_by_visible_text("client")
