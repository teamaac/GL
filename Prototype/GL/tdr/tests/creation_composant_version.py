...
class CreationComposantVersion(unittest.TestCase):
	def setUp(self):
	...
	def test_creation_composant_version(self):
		...
		driver.find_element_by_id("id_titre").send_keys("Test composant")
		...
		driver.find_element_by_name("_save").click()
		# ERROR: Caught exception [ERROR: Unsupported command [selectWindow]]
		driver.find_element_by_css_selector("#add_id_nature > img[alt=\"Add Another\"]").click()
		# ERROR: Caught exception [ERROR: Unsupported command [waitForPopUp]]
